        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {reachMetrics.map((activeMetric, index) => (
              <div
                key={index}
                className="bg-[#0A0A0A] backdrop-blur-xl border border-white/10 p-8 rounded-3xl text-center group hover:border-brand-green/50 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-400 leading-relaxed italic border-l-4 border-brand-green pl-6 py-2 bg-brand-green/5">
              ...
              <Link href="/services" className="inline-flex items-center gap-4 group cursor-pointer pt-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Deploying Core Enterprise Intelligence</p>
                </div>
              </Link>
            </motion.div>
            ...
            >
              {foundationalPrinciples.map((activePrinciple, index) => (
                <div
                  key={index}
                  className={`bg-[#0A0A0A] border border-white/10 p-8 rounded-3xl hover:shadow-2xl hover:shadow-brand-green/10 hover:border-brand-green/40 transition-all duration-500 group ${index === 2 ? 'sm:col-span-2' : ''}`}
                >
                  <div className="text-brand-green mb-6 group-hover:scale-110 transition-transform duration-300">
                    {activePrinciple.valueIcon}
                  </div>
                  <h3 className="text-xl font-extrabold mb-4 uppercase tracking-tighter text-white">
                    {activePrinciple.valueTitle}
                  </h3>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    {activePrinciple.valueDescription}
                  </p>
                </div>
              ))}
            </motion.div>
